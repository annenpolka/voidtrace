...
export const KNOWN_PATTERNS = [
  ...
  "patch_backed_experiment_resolution",
  "finite_parameter_sweep",
  "finite_breakpoint_analysis",
  "patch_isolation",
  "golden_scenario",
...
export type RuleOperation =
  ...
  | {
      kind: "event.expand-resolved-direct-radial-impact";
      maximumTargets: number;
    }
  | {
  ...
  | {
      kind: "damage-vector.aggregate-resolved-direct-radial-impact";
    };
